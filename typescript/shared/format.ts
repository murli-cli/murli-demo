...
export function printTasksCSV(tasks: Task[]): void {
...
export function printTasksJSON(tasks: Task[]): void {
  console.log(JSON.stringify(tasks));
}

export function printLabelsTable(db: Database): void {
  const border = "+-------------+-------------+";
...
export function printSprintReport(db: Database): void {
